...
const updateBookingStatus = async (req, res) => {
  ...
  try {
    ...
    if (!serviceDetails || !serviceDetails.ownerEmail) {
      return res
        .status(400)
        .json({ error: "Service or owner email not found" });
    }
    ...
    switch (status) {
      case "accepted":
        ...
        emailText =
          "Your service booking has been accepted. We will start working on it shortly.";
        break;
      case "rejected":
        emailSubject = "Your service booking is rejected";
        emailText =
          "Unfortunately, your service booking has been rejected. Please contact us for further details.";
        break;
      case "ready":
        emailSubject = "Your service is ready for delivery";
        emailText =
          "Your service is ready for delivery. Please contact us for further details.";
        break;
      case "completed":
        emailSubject = "Your service is completed";
        emailText =
          "Your service has been completed. Thank you for choosing our service.";
        break;
      default:
